...
createChannel(){
    ...
    peer channel create -o localhost:7050 -c channel1 \ --ordererTLSHostnameOverride orderer.example.com \   -f ./artifacts/channel/channel1.tx --outputBlock ./channel-artifacts/channel1.block \   --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
}
